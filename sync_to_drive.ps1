# =========================================================================
# ScrapeBot Google Drive Sync Script (PowerShell Version)
# =========================================================================
...
$SpecFile = "s:\00_Apps\ScrapeBot\scrapebot_spec.md"
$ReadmeFile = "s:\00_Apps\ScrapeBot\README.md"
...
$LegacyFiles = @("README.txt", "profile_and_history.txt", "mission_spec.txt", "scrapebot_spec.md", "README.md")
...
Copy-Item -Path $SpecFile -Destination (Join-Path $DriveDir "scrapebot_spec.txt") -Force
Copy-Item -Path $ReadmeFile -Destination (Join-Path $DriveDir "scrapebot_readme.txt") -Force
